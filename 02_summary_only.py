...
# Description:  
# LastEditors: Shiyuec
# LastEditTime: 2025-05-26 01:14:09
## 
##
# Author:  
# Description:  
...
if __name__ == "__main__":
    models = [ "deepseek-r1",]
    configs = [
        "configs/config3_label.yaml",
        "configs/config4_label.yaml",
        "configs/config5_label.yaml",
        "configs/config6_label.yaml",
        "configs/config8_label.yaml",
        "configs/config9_label.yaml",
        "configs/config10_label.yaml",
